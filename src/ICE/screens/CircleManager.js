...
const renderTabBar = props => (
  <TabBar
    ...
    style={{ backgroundColor: "#0E79BE", fontFamily:"Roboto" }} //#4db8ff
  />
);
...
export default class CircleManager extends Component {

    constructor(props){
        super(props);
        this.state = { 
            index: 0,
            routes: [{ key: 'first', title: 'My Circles' }, { key: 'second', title: 'Other Circles' }],
    ...
    render() {
        ...
        return (
         ...
         <Header
                ...
                leftComponent={<Icon name="keyboard-backspace" color='#fff' size={30} style={{padding:5}} onPress={() => {this.state.edit_mode ? this.setState({edit_mode:false}) : this.props.navigation.goBack()}} />}
                centerComponent={<Text style={{alignSelf:"center",marginTop:10, fontFamily:"Roboto", color:'white', fontSize:25, fontWeight:"300"}}>Circle Manager</Text>}
              //   rightComponent={
              //     this.state.edit_mode ? null :
              //     <View style={{flexDirection:"row"}}>
              //     <Icon name="edit" color='#fff' size={23} style={{padding:5}} onPress={()=>{this.setState({edit_mode:true})}}/>
              //     <Icon name="add" color='#fff' onPress={() => this.props.navigation.navigate('CircleCreate')} size={23} style={{padding:5}}/>
              //     </View>
              // }
                />
            <TabView
                renderTabBar={renderTabBar}
                //sceneContainerStyle={{backgroundColor:"#4db8ff"}}
